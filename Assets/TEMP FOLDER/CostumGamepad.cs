...
#endif
[InputControlLayout(displayName = "arcade Gamepad ", stateType = typeof(ArcadeGamepadState), isGenericTypeOfDevice = true)]
...
#if UNITY_EDITOR
    [UnityEditor.MenuItem("Tools/Add costum gamepad")]
